...
|---|---|---|
| 23. 9. 2026 | – | Návod k appce s obrázky (`docs/navod/README.md`, snímky generuje skript `docs/navod/snimky/snimky.js` z ukázkových dat) a release notes (`docs/release-notes.md`, zpětně od verze 1). V Nastavení → O aplikaci tlačítka Návod a Co je nového. Do CLAUDE.md pravidlo: každá změna = záznam v release notes, změna ovládání = úprava návodu. |
