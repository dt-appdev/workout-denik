...
- [ ] **F4-08** Sdílení souhrnu tréninku jako obrázek. Pokud se bude kreslit přes obrázek z `blob:`/`data:` (např. postava ze SVG), povolit ho v `img-src` v `index.html` (F0-08).
