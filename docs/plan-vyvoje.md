...
| F1-04 | Jak upozornit na konec pauzy, když je appka na pozadí nebo displej zhasnutý? | Vyřešeno 23. 9.: systémové oznámení ze service workeru („Další: cvik · N. série“), vypínatelné v Nastavení; v appce na konci 2 dlouhé vibrace a pípnutí (volba zvuk / vibrace / obojí); přečas „+0:25“ vypínatelný; pauza po zahřívací sérii stejná; oznámení při startu pauzy ne; délka pauzy podle cviku odložena jako F1-09. |
...
|---|---|---|
| 23. 9. 2026 | F1-04 | Záznam z telefonu ukázal, že se zamčeným displejem Android uspí procesor a oznámení se někdy zpozdí o desítky sekund (2 ze 4 pokusů). Přidána pokusná volba „Hlídat pauzu i při zamčeném displeji“ (výchozí vypnutá): během pauzy neslyšitelný tón drží telefon vzhůru, na konci appka pípne i zamčená. Čeká na ověření na telefonu (baterie, hudba). |
